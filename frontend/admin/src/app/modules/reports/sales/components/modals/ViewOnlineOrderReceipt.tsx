...
import { OnlineOrderDetailsModel } from "../../core/_model";

interface Props {
  data: OnlineOrderDetailsModel | null;
}
...
const ViewOnlineOrderReceipt: FC<Props> = ({ data }) => {
