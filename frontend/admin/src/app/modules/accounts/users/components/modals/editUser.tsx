...
const EditUserModal: FC<UserModalProps> = ({
  userID,
  data,
  setRefreshTable,
  onSubmit,
  ...
  const [imagePreviews, setImagePreviews] = useState<string[]>(
    data?.personal_info?.image_cover ? [data.personal_info.image_cover] : []
  )
                ...
                {formik.values.modules.includes('core') && (
                  <div className="col-md-12 mb-3">
                    <RoleSelect
                      ...
                      error={
                          !!formik.errors.role_id && typeof formik.errors.role_id === 'string'
                          ? formik.errors.role_id
                          : undefined
                      }
                      touched={!!formik.touched.role_id}
                    />
                    {formik.touched.role_id && typeof formik.errors.role_id === 'string' && (
