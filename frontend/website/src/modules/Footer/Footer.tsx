      ...
      <footer className="footer">
        <div className="footer__container">
          <div className="footer_left">
            ...
            <p>SM City Calamba National Road, Brgy Real Calamba City Triangle, 4027 Laguna</p>

            <div className="footer_address">
              <strong> support@smhome.com </strong>
              <strong> +1 246-345-0695 </strong>
            </div>

            <div className="social_links">
              <a href="https://www.facebook.com/SMHome.ph" target="_blank"><FaFacebookF /></a>
              <a href="https://www.instagram.com/smhome/" target="_blank"><FaInstagram /></a>
              <a href="https://www.tiktok.com/@smhomeph/" target="_blank"><FaTiktok /></a>
            </div>
          </div>
        ...
        <div className="footer_bottom">
           <p>
            © {getCurrentYear()} SM Home. This is for capstone purposes.
          </p>
          {/* <p>
